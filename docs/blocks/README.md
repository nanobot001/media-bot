...
| **[Block 5-5c](block-5-5c-mediaflow-production-browser-adapter.md)** | MediaFlow Production Browser-Stream Adapter | Planned | Connect the bounded MediaFlow adapter to normal localhost playback behind a reversible flag while preserving direct play, VLC fallback, and secret isolation. |
